...
const ModalDelete : FC<Props> = ({id, text, deleteFunc}) => {
    return (
        <>
            ...
            <button data-modal-target={"popup-modal"+id} data-modal-toggle={"popup-modal"+id}
            ...
            <div id={"popup-modal"+id} tabIndex={-1}
                 className=" bg-gray-900 bg-opacity-50 fixed top-0 left-0 right-0 z-50 hidden p-4 md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                Ви дійсно бажаєте видалить продукт <strong>{text}</strong>
                                ?</h3>
